[![GoDoc](https://godoc.org/github.com/StrongSquirrel/goquery?status.png)](https://godoc.org/github.com/StrongSquirrel/libsignal-protocol-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/StrongSquirrel/libsignal-protocol-go)](https://goreportcard.com/report/github.com/StrongSquirrel/libsignal-protocol-go)
...
- [API Reference](https://godoc.org/github.com/StrongSquirrel/libsignal-protocol-go)
...
Install the Signal library using the "go get" command:
    ...
    go get github.com/StrongSquirrel/libsignal-protocol-go/...
...
```go
import "github.com/StrongSquirrel/libsignal-protocol-go/serializer"
